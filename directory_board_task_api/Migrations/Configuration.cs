namespace directory_board_task_api.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DirectoryBoardContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "directory_board_task_api.Models.DirectoryBoardContext";
        }
        ...
        protected override void Seed(DirectoryBoardContext context)
        {
            ...
            logData.ForEach(p => context.Logs.AddOrUpdate(p));
            context.SaveChanges();
            base.Seed(context);
